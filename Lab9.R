...
abline(0,1, lty=2, col=c..)
text(180,180,"y = x", col=c..)
n0=c(50, 200, 800, 3200)
c0= adjustcolor("blue3", .5)
...
lines(smooth.spline(cars$speed,cars$dist,df=10),lty=2,col='red')
